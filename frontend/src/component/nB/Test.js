                        ...
                        <Card
                            ...
                            <CardContent>
                                <Typography variant={"h6"} gutterBottom>
                                    <b>No:</b>
                                    <br />
                                    <b>F1-Score: </b>{this.state.result.no['f1-score']}
                                    <br />
                                    <b>Precision: </b>{this.state.result.no.precision}
                                    <br />
                                    <b>Recall: </b>{this.state.result.no.recall}
                                    <br />
                                    <b>Support: </b>{this.state.result.no.support}
                                </Typography>
                            </CardContent>
                        </Card>
                    }
                        ...
                        >
                            <CardContent>
                                <Typography variant={"h6"} gutterBottom>
                                    <b>Yes:</b>
                                    <br />
                                    <b>F1-Score: </b>{this.state.result.yes['f1-score']}
                                    <br />
                                    <b>Precision: </b>{this.state.result.yes.precision}
                                    <br />
                                    <b>Recall: </b>{this.state.result.yes.recall}
                                    <br />
                                    <b>Support: </b>{this.state.result.yes.support}
                                </Typography>
                            </CardContent>
                        </Card>
                    }
